<template>
  <div class="goods-comment">
    ...
    <div class="list" v-if="commentList">
      <div class="item" v-for="item in commentList" :key="item.id">
        ...
        <div class="body">
          <div class="score">
            <i class="iconfont icon-wjx01" v-for="i in item.score" :key="i+1"></i>
            <i class="iconfont icon-wjx02" v-for="i in 5-item.score" :key="i+2"></i>
  ...
  <!-- 分页组件 -->
  <xtx-pagination v-if="total" @current-page="changePageFn" :total="total" :pageSize="reqParams.pageSize" :currentPage="reqParams.page"/>
</template>
<script>
...
export default {
  ...
  setup (props) {
    ...
    return { changePageFn, total, commentInfo, currTagIndex, changeTag, changeSort, reqParams, commentList, formatSpecs, formatNickname }
  }
}
</script>
